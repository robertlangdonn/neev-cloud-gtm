  ...
  return (
    <html lang="en" className={`${mono.variable} h-full`}>
      <body className="min-h-full flex flex-col">
        <header className="border-b border-[var(--border)] shrink-0">
        ...
        <footer className="border-t border-[var(--border)]">
          <div className="max-w-5xl mx-auto px-6 py-6 text-xs text-[var(--muted-foreground)] flex flex-col items-center gap-1.5 text-center">
